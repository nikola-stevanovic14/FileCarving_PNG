...
void FileHelper::WriteStringToFile(std::string fileName, std::tuple<std::string, int> toWrite)
{
    std::string string = std::get<0>(toWrite);
    int numOfCharacters = std::get<1>(toWrite);
